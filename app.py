...
# Select which visualizations to display
...
color_map = {serie: palette[i % len(palette)] for i, serie in enumerate(selected_series)}

# --------------------------------------------------
# Correlation Time Series
# --------------------------------------------------
if "Correlation Time Series" in show_charts:
...
# Radar chart
# --------------------------------------------------
if "Correlation Radar" in show_charts:
...
# Minimum Spanning Tree
# --------------------------------------------------
if "Minimum Spanning Tree" in show_charts:
    ...
    node_trace = go.Scatter(
        ...
        marker=dict(size=32, color=node_colors, line=dict(width=1, color="black"))
    )
...
# Summary statistics
# --------------------------------------------------
if "Summary Statistics" in show_charts:
    st.subheader("📊 Summary Statistics")
    stats_df = df[selected_series].agg(["mean", "min", "max"]).T * 100
    stats_df = stats_df.rename(columns={"mean": "Mean", "min": "Min", "max": "Max"})
